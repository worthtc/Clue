...
public class CR_FileInitTests {
	...
	public static void setUp() {
		ClueGame game = new ClueGame("ClueLayout.csv", "ClueLegend.txt", null, null);
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("ClueLayoutBadColumns.csv", "ClueLegend.txt", null, null);
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		ClueGame game = new ClueGame("ClueLayoutBadRoom.csv", "ClueLegend.txt", null, null);
		game.loadRoomConfig();
		//game.getBoard().loadBoardConfig(); Our loadRoomConfig method just loads the room config without the try/catch so we did not need this method
	}
	// Test that an exception is thrown for a bad config file
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		// overloaded Board ctor takes config file name
		ClueGame game = new ClueGame("ClueLayout.csv", "ClueLegendBadFormat.txt", null, null);
		game.loadRoomConfig();
		//game.getBoard().loadBoardConfig(); Our loadRoomConfig method just loads the room config without the try/catch so we did not need this method
	}
}